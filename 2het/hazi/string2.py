...
def front_back(a, b):
    if (len(a) % 2) == 0:
        a_eleje = a[: int(len(a) / 2)]
        a_vege = a[int(len(a) / 2) :]
    else:
        a_eleje = a[: int(len(a) / 2) + 1]
        a_vege = a[int(len(a) / 2) + 1 :]

    if (len(b) % 2) == 0:
        b_eleje = b[: int(len(b) / 2)]
        b_vege = b[int(len(b) / 2) :]
    else:
        b_eleje = b[: int(len(b) / 2) + 1]
        b_vege = b[int(len(b) / 2) + 1 :]
